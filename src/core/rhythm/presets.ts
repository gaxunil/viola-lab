...
export const RHYTHM_PRESETS: readonly RhythmPreset[] = [
...

  {
    ...
    events: rep(9, E),
    tags: ['compound', 'beginner'],
    note: 'The unaltered rhythm of 9/8 — every eighth sounded, beamed three to a beat. Everything else in this list is a variation on it. Count "1 & a 2 & a 3 & a" and let the numbers feel heavier than the rest.',
  },
  {
    id: '9-8-slip-jig-lilt',
    name: 'Long-short (slip jig)',
    meter: NINE_EIGHT,
    events: [n(Q), n(E), n(Q), n(E), n(Q), n(E)],
    tags: ['compound'],
    note: 'Quarter then eighth in each beat, so the first note takes two thirds of the beat and the second one third. This lilt is what makes an Irish slip jig sound the way it does — 9/8 is the slip jig meter.',
  },
  {
    id: '9-8-short-long',
    name: 'Short-long',
    meter: NINE_EIGHT,
    events: [n(E), n(Q), n(E), n(Q), n(E), n(Q)],
    tags: ['compound'],
    note: 'The reverse: the short note first, which pushes forward into the long one instead of leaning back. Play it against the previous example — same notes per beat, opposite character.',
  },
  {
    id: '9-8-dotted-half-and-beat',
    name: 'A held beat and a half',
    meter: NINE_EIGHT,
    events: [n(DH), n(DQ)],
    tags: ['compound', 'dotted'],
    note: 'A dotted half swallows two whole beats, leaving one dotted quarter to finish the bar. Two notes for nine eighths — count all three beats through the long note or you will come off it early.',
  },
  {
    id: '9-8-one-dotted-note',
    name: 'One dotted note',
    meter: NINE_EIGHT,
    events: [n(DQ), ...rep(6, E)],
    tags: ['compound', 'dotted', 'beginner'],
    note: 'Straight eighths except beat one, held as a single dotted quarter. The dotted quarter is exactly the three eighths it replaced — the same idea as in 12/8, one beat shorter.',
  },
  {
    id: '9-8-tie-across-beats',
    name: 'Tied across the beat',
    meter: NINE_EIGHT,
    events: [n(Q), n(E, { tiedToNext: true }), n(Q), n(E), n(DQ)],
    tags: ['compound', 'ties'],
    note: 'The last eighth of beat one is tied into beat two, so beat two arrives without being played. Saying "2" while not playing it is the whole skill here.',
  },
  {
    id: '9-8-offbeat-rests',
    name: 'Rests on the downbeats',
    meter: NINE_EIGHT,
    events: [r(E), n(E), n(E), r(E), n(E), n(E), r(E), n(E), n(E)],
    tags: ['compound', 'syncopation'],
    note: 'Every beat starts with silence. Keep counting "1 & a" out loud — the beat is still there, you are simply not playing on it, and the moment you stop counting it will drift.',
  },
  {
    id: '9-8-irregular-2223',
    name: 'Grouped 2+2+2+3',
    meter: meter(9, 8, { grouping: [2, 2, 2, 3] }),
    events: rep(9, E),
    tags: ['asymmetric'],
    note: 'The same nine eighths, regrouped. Now it is four uneven beats rather than three even ones, and it stops being compound at all — this is how 9/8 is often used in Balkan music. Listen for where the accents move.',
  },
